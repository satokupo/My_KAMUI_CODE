...
【01_ホーム】: nav, hero-section, service-features-a, service-features-b, pricing-table, contact, footer
【02_料金】: nav, pricing-hero, plan-comparison, faq, footer
... (以下略)
...
.venv/Scripts/python.exe docs/helper/setup_relume_project.py \
  --root-dir "s:/MyProjects/KAMUI_CODE/Relume/2025-10-08_satokupo-design-test/copy-of-ホームページ作成サービス" \
  --page "01_ホーム:nav,hero-section,service-features,pricing-table,contact,footer" \
  --page "02_料金:nav,pricing-hero,plan-comparison,faq,footer" \
  --page "03_サービス紹介:nav,service-hero,service-list,testimonials,footer"
```
